...
6. **The formal direct-port camera soak passed but saved a black C270 startup frame** — the run sustained C920 29.91 fps and C270 29.98 fps for 30 minutes with zero failed reads, and warmed samples confirmed both semantic views. The preflight now retains the final successful frame so future evidence is captured after exposure settles. An unnecessary later agent rerun was excluded from qualification; the original passing report remains canonical.
