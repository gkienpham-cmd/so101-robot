...
| 2026-07-16 | 2× 26 cm USB ring light + 2.1 m stand ("Đèn 26cm + Chân Đèn") | Phụ Kiện Vu Phat (Shopee) | 390,000 (2×195,000 − 10,000 bundle) — ORDERED | ~$15 | Workspace lighting rig (docs/hardware_and_safety.md). On arrival: same model/batch check, white mode, tape dials. |
